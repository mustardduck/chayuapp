...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _countBtn.titleLabel.font = [UIFont systemFontOfSize:11];
        [_countBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        _countBtn.backgroundColor = [UIColor colorWithRed:38 /255.0 green:38 /255.0 blue:38 /255.0 alpha:0.8];
        _countBtn.layer.cornerRadius = 17.5;
...
- (void)pushToAd{
    ...
    switch (type) {
        ...
        case 2:
        {
            ...
            vc.wenzhangId = [guanggaoInfo objectForKey:@"data"];
            //            //vc.hidesBottomBarWhenPushed = YES;
            [viewCon pushViewController:vc animated:YES];
        }
            break;
