...
{
    if(_mArticleInfo.desc.length + _mArticleInfo.shareurl.length >= 140)
    {
        NSString * desc = [_mArticleInfo.desc substringToIndex:(139 - _mArticleInfo.shareurl.length)];
        
        _mArticleInfo.desc = desc;
    }
