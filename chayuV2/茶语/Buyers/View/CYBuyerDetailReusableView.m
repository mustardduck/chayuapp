...
- (void) setDetailInfo:(CYBuyerDetailInfo *)detailInfo
{
    ...
    [_sellerImgView sd_setImageWithURL:[NSURL URLWithString:_detailInfo.avatar] placeholderImage:DEFAULTHEADER];
    
    [_wap_thumb sd_setImageWithURL:[NSURL URLWithString:_detailInfo.wap_thumb] placeholderImage:[UIImage imageNamed:@"750×400"]];
