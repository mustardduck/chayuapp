...
@interface CYCarousel()<UICollectionViewDelegate,UICollectionViewDataSource>
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return [_delegate zzcarousel:collectionView viewForItemAtIndex:indexPath itemsIndex:itemIndex identifire:@"ZZWheelCell"];
}
