...
- (void)tableView:(SKSTableView *)tableView didSelectRowAtIndexPath:(nonnull NSIndexPath *)indexPath;

- (void)tableView:(SKSTableView *)tableView willDisplaySubCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath;
