...
@protocol CYBuyerSKSTableViewCellDelegate;
...
@property (nonatomic, strong) id<CYBuyerSKSTableViewCellDelegate> delegate;
...
@protocol CYBuyerSKSTableViewCellDelegate <NSObject>
